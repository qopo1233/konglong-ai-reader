...
3. **浏览文章**：点击公众号查看其历史文章。
4. **搜索文章**：在公众号文章列表页面，使用取消收藏按钮旁边的搜索框，输入关键词搜索文章。
5. **AI 阅读**：点击文章的"AI 阅读"按钮，获取 OpenAI 智能总结。
6. **收藏管理**：可收藏公众号和文章，便于快速访问。
7. **设置面板**：在"设置→模型配置"中自定义 OpenAI API 地址、模型、流式输出和 API Key。
